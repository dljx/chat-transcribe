...
vertexai.init(project="ml-product-study", location="asia-southeast1")  # Replace with your project and location
# Configure logging
logging.basicConfig(
    level=logging.INFO,
...
GCS_BUCKET_NAME = "gemini-transcription-bucket-dbs"  # Replace with your bucket name
...
def main():
    ...
    while recording:
        # Process the callback queue in the main thread
